    ...
    >
      ...
      <Container maxWidth="md" sx={{ position: "relative", zIndex: 1, py: 4 }}>
        ...
        <Box sx={{ textAlign: "center", mb: 6 }}>
          ...
          >
            Transform your Excel data into powerful insights. Upload, analyze,
            and visualize your spreadsheets effortlessly.
          </Typography>
        </Box>
        ...
        <Box sx={{ textAlign: "center" }}>
          <Button
            ...
            onClick={() =>
              navigate(user ? "/dashboard" : "/login") // ✅ logic here
            }
          >
            {user ? "Go to Dashboard" : "Get Started"} {/* ✅ button label */}
          </Button>
        </Box>
        ...
        >
          ...
          >
            Developed by{" "}
            <strong style={{ color: "#ffffff" }}>@mitesh Thakor</strong>
          </Typography>
        </Box>
      </Container>
